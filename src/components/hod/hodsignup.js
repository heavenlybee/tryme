...
function HodSignup() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // this is just visual feedback for the user for this demo
      // this will not be an error, rather we will show a different UI or redirect the user to the dashboard
          ...
          >
            ...
            <FormControl variant="filled">
              ...
              <FormHelperText error={errors.password}>
                ...
                uppercase letter, 1 lowercase letter, and 1 digit
              </FormHelperText>
            </FormControl>
